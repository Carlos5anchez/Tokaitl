  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      children: <Widget>[
        ...
        _creacionResponsiva(context, 'assets/ave.png', 'Animales', 'Yolkáme',
            20, 255, 255, 253, 235),

        SizedBox(
          height: 10.0,
        ),
        _creacionResponsiva(context, 'assets/pajaro.png', 'Colores', 'Yolkáme',
            20, 255, 222, 248, 247),
        SizedBox(
          height: 10.0,
        ),
        _creacionResponsiva(context, 'assets/perrito.png', 'Animales',
            'Yolkáme', 20, 255, 246, 235, 255),
        SizedBox(
          height: 10.0,
        ),
      ],
...
Widget _creacionResponsiva(BuildContext context, String foto, String nombre,
    String traduccion, int palabras, int a, int r, int g, int b) {
            ...
            child: Container(
              decoration: BoxDecoration(
                boxShadow: [
                  ...
                  BoxShadow(color: Color.fromARGB(a, r, g, b)),
                ],
              ),
              child: Row(
...
Widget _circulo(double x, double y, double diametro, int r1, int g1, int b1) {
  return Transform.translate(
    ...
    child: Material(
      ...
      shape: CircleBorder(
          side: BorderSide(color: Colors.transparent, width: 15.0)),
    ),
  );
}
