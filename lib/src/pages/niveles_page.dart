      ...
      body: Container(
        ...
        height: medida.height,
          ...
          decoration: BoxDecoration(
              image: DecorationImage(image: AssetImage("assets/test.gif"), fit: BoxFit.cover),
          ),
          child: Column(
        children: <Widget>[
          SafeArea(child: 
...
return GestureDetector(
                ...
                child: Text('$numero',textScaleFactor: 5.5,textAlign: TextAlign.center,style: TextStyle(fontWeight: FontWeight.w500,color: Colors.blueGrey)),
